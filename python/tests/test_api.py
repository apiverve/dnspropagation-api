...
class TestDnspropagationAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = DnspropagationAPIClient(self.api_key)

    @patch('apiverve_dnspropagationchecker.apiClient.requests.get')
