# DNS Propagation Checker Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:dnspropagation-api:1.1.13'
}
```
...
```java
import com.apiverve.dnspropagation.DNSPropagationCheckerAPIClient;
import com.apiverve.dnspropagation.APIResponse;
import com.apiverve.dnspropagation.APIException;

// Initialize the client
DNSPropagationCheckerAPIClient client = new DNSPropagationCheckerAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dnspropagation](https://docs.apiverve.com/ref/dnspropagation)
...
- **Documentation:** [https://docs.apiverve.com/ref/dnspropagation](https://docs.apiverve.com/ref/dnspropagation)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dnspropagation-api/issues)
