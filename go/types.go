// Package dnspropagation provides a Go client for the DNS Propagation Checker API.
//
// For more information, visit: https://apiverve.com/marketplace/dnspropagation?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the DNS Propagation Checker API.
//
// Parameters:
//   - domain (required): string - The domain name to check propagation for [format: domain]
//   - type: string - The DNS record type to check
type Request struct {
...
// ResponseData contains the data returned by the DNS Propagation Checker API.
type ResponseData struct {
	Domain string `json:"domain"`
	RecordType string `json:"recordType"`
	PropagationComplete bool `json:"propagationComplete"`
	ServersChecked int `json:"serversChecked"`
	ServersResponded int `json:"serversResponded"`
	UniqueResponses int `json:"uniqueResponses"`
