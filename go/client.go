...
const (
	baseURL        = "https://api.apiverve.com/v1/dnspropagation"
	defaultTimeout = 30 * time.Second
)

// Client is the DNS Propagation Checker API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new DNS Propagation Checker API client.
...
// Execute makes a request to the DNS Propagation Checker API with typed parameters.
//
