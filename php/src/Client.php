...
namespace APIVerve\Dnspropagation;
...
/**
 * Client for the DNS Propagation Checker API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://dnspropagation.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dnspropagation';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DnspropagationClient] {$message}\n";
        }
    }
}
