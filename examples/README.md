# DNS Propagation Checker API - Examples

This folder contains example code for using the DNS Propagation Checker API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/dnspropagation',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/dnspropagation");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/dnspropagation](https://docs.apiverve.com/ref/dnspropagation)
