...
namespace APIVerve.API.DNSPropagationChecker
{
    ...
    /// <summary>
    /// Client for the DNSPropagationChecker API
    /// </summary>
    public class DNSPropagationCheckerAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/dnspropagation";
        ...
        public DNSPropagationCheckerAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DNSPropagationCheckerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DNSPropagationCheckerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DNSPropagationCheckerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DNSPropagationCheckerQueryOptions options)
        {
        ...
        public ResponseObj Execute(DNSPropagationCheckerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DNSPropagationCheckerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DNSPropagationCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DNSPropagationCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DNSPropagationCheckerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DNSPropagationCheckerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DNSPropagationCheckerQueryOptions options)
        {
