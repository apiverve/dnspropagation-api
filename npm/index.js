...
class dnspropagationWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/dnspropagation');
        }
        ...
        this.validationRules = {"domain":{"type":"string","required":true,"format":"domain"},"type":{"type":"string","required":false,"default":"A"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/dnspropagation`);
        }
    }
...
module.exports = dnspropagationWrapper;
